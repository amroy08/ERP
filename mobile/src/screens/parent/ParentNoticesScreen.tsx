    ...
    <ScreenContainer>
      ...
      >
        ...
        {!loading && data.map((notice) => (
          <AppCard
            key={notice.id}
            style={[styles.noticeCard, expanded === notice.id ? { borderColor: colors.parent + '55', borderWidth: 1 } : undefined]}
          ...
          >
            ...
            <Text style={styles.tapHint}>{expanded === notice.id ? 'Tap to collapse' : 'Tap to read more'}</Text>
          </AppCard>
        ))}
